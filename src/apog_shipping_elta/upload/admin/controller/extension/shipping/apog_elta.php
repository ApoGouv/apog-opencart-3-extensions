...
/**
 * Class ControllerExtensionShippingApogElta
 *
 * Administrative controller for the ELTA Courier shipping module.
 *
 * Responsibilities:
 ...
 */
class ControllerExtensionShippingApogElta extends Controller {
     ...
     */
    protected $module_code = 'apog_elta';
    ...
    public function index() {
        ...
        // Fetch all global settings into $data (shipping_apog_elta_status, etc.)
