...
/**
 * Class ControllerExtensionShippingApogStorePickup
 *
 * Administrative controller for the Store Pickup shipping module.
 *
 * Responsibilities:
 ...
 */
class ControllerExtensionShippingApogStorePickup extends Controller {
    ...
    public function index() {
        ...
        // Fetch all global settings into $data (shipping_apog_store_pickup_status, etc.)
