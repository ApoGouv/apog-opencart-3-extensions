...
/**
 * Class ControllerExtensionPaymentApogPayAtStore
 *
 * Administrative controller for the Pay At Store payment module.
 *
 * Responsibilities:
 ...
 */
class ControllerExtensionPaymentApogPayAtStore extends Controller {
