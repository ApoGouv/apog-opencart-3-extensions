...
class ControllerExtensionTotalApogCodFee extends Controller {
    ...
    protected const BINDING_PAYMENT_CODE = 'apog_cod';
    ...
    public function index() {
        ...
        // Fetch all global settings into $data (total_apog_cod_fee_status, etc.)
